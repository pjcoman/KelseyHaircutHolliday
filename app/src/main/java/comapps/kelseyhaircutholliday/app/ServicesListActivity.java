...
public class ServicesListActivity extends ListActivity {
    ...
    private BackendlessCollection<ServicesObject> servicescollection;
    private List<ServicesObject> serviceslist = new ArrayList<>();

    private boolean isLoadingItems = false;
    private ServicesListViewAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* String whereClause = "price != ''";
        ...
        Backendless.Data.of( ServicesObject.class ).find(query, new LoadingCallback<BackendlessCollection<ServicesObject>>
                (this, "loading services...", true) {

            @Override
            public void handleResponse(BackendlessCollection<ServicesObject> servicesBackendlessCollection) {
                servicescollection = servicesBackendlessCollection;
                addMoreItems(servicesBackendlessCollection);
                super.handleResponse(servicesBackendlessCollection);
            }
        ...
        list.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView view, final int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                if(needToLoadItems(firstVisibleItem, visibleItemCount, totalItemCount)) {
                    isLoadingItems = true;
                    servicescollection.nextPage(new LoadingCallback<BackendlessCollection<ServicesObject>>(ServicesListActivity.this) {
                        @Override
                        public void handleResponse(BackendlessCollection<ServicesObject> nextPage) {
                            servicescollection = nextPage;
    ...
    private void addMoreItems( BackendlessCollection<ServicesObject> nextPage) {
        serviceslist.addAll(nextPage.getCurrentPage());
